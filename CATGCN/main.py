...
from input_data import preprocess_data,load_sz_data,load_los_data,load_my1_data
...
#f = open('test.txt', 'w')
#f.write('min_rmse:%r'%(np.min(test_rmse)),
#      'min_mae:%r'%(test_mae[index]),
#      'max_acc:%r'%(test_acc[index]),
#      'r2:%r'%(test_r2[index]),
#      'var:%r'%test_var[index])